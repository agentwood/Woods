    ...
    <div className="min-h-dvh bg-bg text-fg">
      ...
      <section className="relative isolate overflow-hidden border-b-2 border-border">
        ...
        <div className="relative mx-auto grid min-h-[620px] max-w-7xl items-center gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
          ...
          <div className="order-1 max-w-xl lg:order-2">
            <p className="jw-rise font-pixel text-sm tracking-[0.3em] text-blue">THE SKILL ARCADE</p>
            <h1 className="hero-title jw-rise-2 mt-5 text-6xl sm:text-8xl">
              Enter
              <span className="block text-purple">the Woods</span>
            </h1>
            <p className="jw-rise-3 mt-7 max-w-lg text-base leading-8 text-fg/80 sm:text-lg">
              A pixel-powered training ground for people who want to do real work, not collect another certificate.
            </p>
            <div className="jw-rise-4 mt-9 flex flex-wrap items-center gap-4">
              <SignedOut>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="flex items-end justify-between gap-4">
          <div>
            <p className="font-pixel text-sm tracking-widest text-blue">SELECT YOUR LOADOUT</p>
            <h2 className="mt-3 font-pixel text-3xl sm:text-4xl">Choose a world</h2>
          </div>
      ...
      <section className="pixel-grid mx-auto max-w-7xl border-y-2 border-border px-4 py-20 sm:px-6">
        <h2 className="font-pixel text-3xl sm:text-4xl">The Woods rulebook</h2>
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { title: "Pick a world", body: "Power BI. Docker. TypeScript. AI agents. Each skill is its own game." },
            { title: "Try it first", body: "A 3-minute challenge. No sign-up. See if you have the instincts." },
            { title: "Gain XP", body: "Missions, mini-projects, bosses. Keep a streak. Stack mastery." },
            { title: "Beat the boss", body: "Diagnose the outage. Recover the commit. Brief the board." },
          ].map((item) => (
      ...
      <section className="border-t border-border">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-16 md:grid-cols-2 md:items-center">
          <div>
            <h2 className="font-pixel text-3xl sm:text-4xl">Build an awesome career</h2>
            <p className="mt-4 max-w-md text-muted">
              Twelve tech worlds. Real missions. The moment you stop collecting XP and start doing the job.
            </p>
